        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                foreach (XmlNode node in nodes)
                {
                    ...
                    string renewalbooleanevaluation = node.SelectSingleNode("renewal-upcoming").InnerText; // Read as string, then assign boolean according to condition
            ...
            catch (Exception XMLNotFound)
            {
                Console.WriteLine("< XML-file not found. >");
                Console.WriteLine("");
                Console.WriteLine("");
                Console.WriteLine("Please check if the path to XML-file is correct.");
                Console.WriteLine("");
                Console.WriteLine("");
            }
        }
